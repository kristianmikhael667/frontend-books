...
import { getAllCategory } from "../../store/action/BooksAction";
import { Catalog, Event, Footer, Header, Sidebar } from "../components";
import { Loading } from "../components/Atom";
import { Link, useNavigate } from "react-router-dom";
import Cookies from "js-cookie";
import { getAllHistory } from "../../store/action/BorrowAction";
...
const HistoryPage = () => {
  ...
  useEffect(() => {
    if (token) {
      ...
      dispatch(getAllHistory(jwtToken));
    } else {
                  ...
                  <div id="page-contents" className="row merged20">
                    <div className="col-lg-8">
                      <div className="main-wraper">
                        <h3 className="main-title">History Borrow Book</h3>
                          ...
                          <div className="notification-box">
                            <ul>
                              {getListHistoryBookLoading ? (
                                ...
                                getListHistoryBookResult.length > 0 ? (
                                getListHistoryBookResult.map((data, key) => {
                                  return (
                                    <li>
                                      <img
                                        src={
                                          BASE_URL + API + "/" + data.cover_book
                                        }
                                        width={"100%"}
                                        height={100}
                                        alt=""
