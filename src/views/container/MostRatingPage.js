...
const MostRatingPage = () => {
  const {
    getListMostRatingDataLoading,
    getListMostRatingDataResult,
    getListMostRatingDataError,
                      ...
                      <div className="main-wraper">
                        ...
                        <div className="row col-xs-6">
                          ...
                          {getListMostRatingDataLoading ? (
                            ...
                            getListMostRatingDataResult.length > 0 ? (
