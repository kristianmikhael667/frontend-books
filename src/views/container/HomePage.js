...
import { getAllBooks, getAllCategory } from "../../store/action/BooksAction";
import { Link } from "react-router-dom";
import { Loading } from "../components/Atom";

const HomePage = () => {
  const {
    getListBookDataLoading,
    getListBookDataResult,
    getListBookDataError,
                      ...
                      <div className="main-wraper">
                        ...
                        <div className="row col-xs-6">
                          ...
                          {getListBookDataLoading ? (
                            ...
                            getListBookDataResult.length > 0 ? (
                            getListBookDataResult.map((data, key) => {
                              return (
